...
INSERT INTO dishes ( date, description, restaurant_id, price ) VALUES
  ( NOW(), 'CrumbPotato', 100003, 10000 ),   --100006
  ( NOW(), 'BelyashVIP', 100004, 5500), --100007
  ( NOW(), 'LeBigMak', 100005, 15000 );  --100008

INSERT INTO votes (restaurant_id, user_id, dish_id) VALUES
  ( 100003,  100000, 100008),--100009
